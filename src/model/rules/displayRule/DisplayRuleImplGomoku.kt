...
class DisplayRuleImplGomoku : AbstractDisplayRule() {
    /**
     * @param statistics
     * @return
     */
    ...
    override fun displayPlayerInfo(statistics: GameStatistics, rule: Rule) {
        ...
        run {
            require(displayBlocks[4] is TextBlock) { "The block is not a TextBlock" }
            val textBlock = displayBlocks[4] as TextBlock
    ...
    companion object {
        val displayRule: DisplayRule = DisplayRuleImplGomoku()
    }
}
