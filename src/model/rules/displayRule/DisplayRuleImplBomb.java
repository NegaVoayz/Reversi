...
public class DisplayRuleImplBomb extends AbstractDisplayRule {

    private static final DisplayRule INSTANCE = new DisplayRuleImplBomb();
    ...
    public boolean buildView(GameStatistics statistics, Rule rule) {
        ...
        // add bomb view
        DisplayBlock bombView = new DisplayBlock(
                new Rect(0,0,0,3),
                AlignType.MIDDLE, AlignType.MIDDLE);
        bombView.setChildLayout(ChildLayout.UP_TO_DOWN);
        bombView.addChild(
                new TextBlock("Bombs"));
        bombView.addChild(
                new TextBlock("WhitePlayerBombs"));
        bombView.addChild(
                new TextBlock("BlackPlayerBombs"));
        bombView.addChild(
                new TextBlock(""));
        bombView.addChild(
                new TextBlock(""));
    ...
    protected void displayPlayerInfo(GameStatistics statistics, Rule rule) {
        ...
        if(!(statistics.getView().getChildren().get(2) instanceof DisplayBlock bombView)) {
            throw new IllegalArgumentException("The bomb view is not a DisplayBlock");
        }
        if(!(statistics.getExtraInfo() instanceof GameRuleImplBomb.BombRecord bombRecord)) {
            throw new IllegalArgumentException("Did you say the bomb version has no bomb?");
        }

        ArrayList<AbstractDisplayBlock> bombViewChildren = bombView.getChildren();
        ArrayList<AbstractDisplayBlock> playerViewChildren = playerView.getChildren();

        // Black Bombs
        {
            if(!(bombViewChildren.get(1) instanceof TextBlock textBlock)) {
                throw new IllegalArgumentException("The block is not a TextBlock");
            }
            textBlock.setText(String.valueOf(bombRecord.getWhiteBombCount()));
        }
        // White Bombs
        {
            if(!(bombViewChildren.get(2) instanceof TextBlock textBlock)) {
                throw new IllegalArgumentException("The block is not a TextBlock");
            }
            textBlock.setText(String.valueOf(bombRecord.getBlackBombCount()));
        }
        ...
        // White player info
        {
            ...
            if(!(playerViewChildren.get(1) instanceof TextBlock textBlock)) {
                throw new IllegalArgumentException("The block is not a TextBlock");
            }
        ...
        // Black player info
        {
            ...
            if(!(playerViewChildren.get(2) instanceof TextBlock textBlock)) {
                throw new IllegalArgumentException("The block is not a TextBlock");
            }
            textBlock.setText(buf.toString());
        }
        ...
        {
            if(!(playerViewChildren.get(3) instanceof TextBlock textBlock)) {
                throw new IllegalArgumentException("The block is not a TextBlock");
            }
        ...
        {
            if(!(playerViewChildren.get(4) instanceof TextBlock textBlock)) {
                throw new IllegalArgumentException("The block is not a TextBlock");
            }
